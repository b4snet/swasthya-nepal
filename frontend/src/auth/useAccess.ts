...
export const PERMISSIONS = {
  ...
  FORMS_VERIFY: 'forms:verify',
  FORMS_APPROVE: 'forms:approve',
  // Catalog / infrastructure (Phase 4)
  ...
  // Lab lifecycle (entry ≠ verification)
  LAB_PROCESS: 'lab:process',
  LAB_REPORT: 'lab:report',
  // Pharmacy returns / reversals
  PHARMACY_RETURN: 'pharmacy:return',
  // Billing configuration
  BILLING_MANAGE: 'billing:manage',
  // HR payroll export
  HR_PAYROLL_EXPORT: 'hr:payroll_export',
  // Assets
  ...
  // Telehealth
  TELEHEALTH_SCHEDULE: 'telehealth:schedule',
  TELEHEALTH_CONDUCT: 'telehealth:conduct',
  TELEHEALTH_RECORD: 'telehealth:record',
  // Remote Patient Monitoring
  RPM_VIEW: 'rpm:view',
  RPM_MANAGE: 'rpm:manage',
  RPM_INGEST: 'rpm:ingest',
  RPM_ACKNOWLEDGE: 'rpm:acknowledge',
  // CDSS / AI
  CDSS_VIEW: 'cdss:view',
  CDSS_MANAGE: 'cdss:manage',
  AI_VIEW: 'ai:view',
  AI_MANAGE: 'ai:manage',
  AI_INVOKE: 'ai:invoke',
  AI_SIGN: 'ai:sign',
  ...
  const can = (permission: PermissionCode): boolean => {
    ...
    const rolePermissions: Record<string, PermissionCode[]> = {
      ...
      [ROLES.ORG_ADMIN]: [
        ...
        PERMISSIONS.QUEUE_VIEW, PERMISSIONS.CLINICAL_MANAGE,
      ...
      [ROLES.LAB_SUPERVISOR]: [
        PERMISSIONS.PATIENT_VIEW, PERMISSIONS.PATIENT_SEARCH,
        PERMISSIONS.LAB_VIEW, PERMISSIONS.LAB_VERIFY,
      ],
      [ROLES.RADIOGRAPHER]: [
        PERMISSIONS.PATIENT_VIEW, PERMISSIONS.PATIENT_SEARCH,
