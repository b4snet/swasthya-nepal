...
const NAV: Array<{ to: string; labelKey: MessageKey; icon: string; roles: string[] }> = [
  ...
  { to: '/budgets', labelKey: 'nav.budgets', icon: '📋', roles: [] },
  { to: '/expenses', labelKey: 'nav.expenses', icon: '🧾', roles: [] },
  { to: '/financial-periods', labelKey: 'nav.financialPeriods', icon: '📅', roles: [] },
  ...
  { to: '/portal', labelKey: 'nav.portal', icon: '🏥', roles: [] },
