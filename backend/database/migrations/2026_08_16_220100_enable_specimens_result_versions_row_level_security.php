...
/**
 * Phase 3 slice 15 — RLS for the Laboratory custody/correction surface
 ...
 * (Phase 1 hardening).
 *
 * Policy count added: 2 tables × 4 policies = 8 (220 → 228).
 * Scoped matrix: 56 → 58 tables (still 15 off).
 */
return new class extends Migration
{
    /** @var list<string> */
    private const TABLES = ['specimens', 'lab_result_versions'];
