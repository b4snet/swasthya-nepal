...
/**
 * Phase 3 slice 7 — RLS for the laboratory critical-value escalation surface
 * (critical_value_events).
 *
 * TENANT_FACILITY tier — the exact same policy shape as lab_orders/encounters
 ...
 * (Phase 1 hardening).
 *
 * Policy count added: 1 table × 4 policies = 4 (176 → 180).
 * Scoped matrix: 45 → 46 tables (still 15 off).
 */
return new class extends Migration
{
    /** @var list<string> */
    private const TABLES = ['critical_value_events'];
