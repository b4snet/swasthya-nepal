...
/**
 * Phase 3 slice 5 — RLS for the billing refund/adjustment surface
 * (refund_requests).
 *
 * TENANT_FACILITY tier — the exact same policy shape as charges/invoices/
 * payments (SECURITY.md §8, TENANT.md §6.2):
 *
 ...
 * (Phase 1 hardening).
 *
 * Policy count added: 1 table × 4 policies = 4 (168 → 172).
 * Scoped matrix: 43 → 44 tables (still 15 off).
 */
return new class extends Migration
{
    /** @var list<string> */
    private const TABLES = ['refund_requests'];
