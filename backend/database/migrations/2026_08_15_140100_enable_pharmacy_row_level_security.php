...
/**
 * Phase 3 slice 3 — RLS for the pharmacy domain (inventory_items,
 * inventory_movements).
 *
 * Both tables are TENANT_FACILITY tier — the exact same policy shape as
 * medications/encounters/lab (SECURITY.md §8, TENANCY.md §6.2):
 *
 ...
 *
 * Policy count added: 2 tables × 4 policies = 8 (156 → 164).
 * Scoped matrix: 40 → 42 tables on (still 15 off).
 */
return new class extends Migration
{
    /** @var list<string> */
    private const TABLES = ['inventory_items', 'inventory_movements'];
