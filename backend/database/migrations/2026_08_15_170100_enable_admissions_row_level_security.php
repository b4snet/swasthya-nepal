...
/**
 * Phase 3 slice 6 — RLS for the IPD admission/discharge surface
 * (admissions).
 *
 * TENANT_FACILITY tier — the exact same policy shape as encounters/charges
 * (SECURITY.md §8, TENANT.md §6.2):
 *
 ...
 * (Phase 1 hardening).
 *
 * Policy count added: 1 table × 4 policies = 4 (172 → 176).
 * Scoped matrix: 44 → 45 tables (still 15 off).
 */
return new class extends Migration
{
    /** @var list<string> */
    private const TABLES = ['admissions'];
