...
/**
 * Phase 3 slice 25 — RLS for the RPM surface (rpm_devices, rpm_readings,
 * rpm_alerts).
 *
 * TENANT_FACILITY tier — the exact same policy shape as the IPD nursing
 * surface (SECURITY.md §8, TENANCY.md §6.2):
 *
 ...
 * (Phase 1 hardening).
 *
 * Policy count added: 3 tables × 4 policies = 12 (476 → 488).
 * Scoped matrix: 120 → 123 tables.
 */
return new class extends Migration
{
    /** @var list<string> */
    private const TABLES = ['rpm_devices', 'rpm_readings', 'rpm_alerts'];
