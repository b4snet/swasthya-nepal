...
/**
 * Phase 3 slice 17 — RLS for the Pharmacy batch/expiry surface
 * (stock_batches).
 *
 ...
 * (Phase 1 hardening).
 *
 * Policy count added: 1 table × 4 policies = 4 (244 → 248).
 * Scoped matrix: 62 → 63 tables (still 15 off).
 */
return new class extends Migration
{
    /** @var list<string> */
    private const TABLES = ['stock_batches'];
