...
/**
 * Phase 3 slice 13 — RLS for the IPD nursing surface (transfer_events,
 * nursing_notes, mar_entries, vital_observations).
 *
 * TENANT_FACILITY tier — the exact same policy shape as admissions/encounters
 ...
 * (Phase 1 hardening).
 *
 * Policy count added: 4 tables × 4 policies = 16 (188 → 204).
 * Scoped matrix: 48 → 52 tables (still 15 off).
 */
return new class extends Migration
{
    /** @var list<string> */
    private const TABLES = ['transfer_events', 'nursing_notes', 'mar_entries', 'vital_observations'];
