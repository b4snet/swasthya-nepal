...
/**
 * Phase 3 slice 24 — RLS for the Telehealth surface (teleconsults,
 * video_sessions). Both are TENANT_FACILITY (facility-run virtual care,
 * exactly like OPD — DATABASE.md §3.55, PRODUCT_REQUIREMENTS §6.20):
 *
 *   SELECT/UPDATE/DELETE using  tenant_id = <tenant>
 *                                AND (facility_id = <facility> OR <facility> IS NULL)
...
{
    /** @var list<string> */
    private const TABLES = ['teleconsults', 'video_sessions'];
