...
/**
 * Phase 3 slice 16 — RLS for the Radiology surface (modalities, studies,
 * radiology_reports, image_references).
 *
 ...
 * (Phase 1 hardening).
 *
 * Policy count added: 4 tables × 4 policies = 16 (228 → 244).
 * Scoped matrix: 58 → 62 tables (still 15 off).
 */
return new class extends Migration
{
    /** @var list<string> */
    private const TABLES = ['modalities', 'studies', 'radiology_reports', 'image_references'];
