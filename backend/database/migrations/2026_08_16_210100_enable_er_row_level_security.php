...
/**
 * Phase 3 slice 14 — RLS for the Emergency surface (er_registrations,
 * triage_scales, triage_assignments, er_events).
 *
 * TENANT_FACILITY tier — the exact same policy shape as the clinical spine
 ...
 * (Phase 1 hardening).
 *
 * Policy count added: 4 tables × 4 policies = 16 (204 → 220).
 * Scoped matrix: 52 → 56 tables (still 15 off).
 */
return new class extends Migration
{
    /** @var list<string> */
    private const TABLES = ['er_registrations', 'triage_scales', 'triage_assignments', 'er_events'];
