...
{
    public function listProfiles(Request $r): JsonResponse { return Envelope::success(data: [], request: $r); }
    public function storeProfile(Request $r): JsonResponse { return Envelope::success(data: ['id' => 'stub'], request: $r); }
